...
- (BOOL)becomeFirstResponder {
	// we will toggle our view here. 
	// This allows us to react properly when in a table cell.
...
- (void)didMoveToSuperview 
{
	...
	pickerView = [[UIComboBoxPickerView alloc] initWithFrame:CGRectZero];
...
- (void)pickerView:(UIPickerView *)pickerView didSelectRow:(NSInteger)row inComponent:(NSInteger)component {
	...
	[delegate selectedRowChange:self Row:row inComponent:component];
	if(string != nil){
